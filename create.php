...
<head>
    ...
    <title><?=$s['app']['setup']['name']?> - Create</title>
    <link href="css/imports.css" rel="stylesheet">
    <link href="css/config.css" rel="stylesheet">
    <link rel="stylesheet" href="css/snackbar.css" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@sweetalert2/theme-dark@5/dark.css" />
	<link rel="icon" href="<?=$s['app']['setup']['icon']?>" type="image/png">
...
<body>
                    ...
                    <div class="login-box" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <form method="post" id="login-form">
                            ...
                            <select id="type" class="form-control" onchange="toggle()">
                                <option value="quadhook">Quadhook</option>
    ...
    <script src="https://kit.fontawesome.com/44623006da.js"></script>
