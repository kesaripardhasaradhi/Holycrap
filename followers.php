...
<head>
    ...
    <title><?=$info['name']?> - Bot Followers</title>
        ...
        <div class="container">
            <div class="row text-center justify-content-center">
                <div class="col-12">
                    <div class="text-top">
                        <h1>Bot Followers</h1>
                        <p>Bot your followers with ease, with this brand new powershell-based system!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <form method="post">
                            <div class="form-input-icon mb-3 mt-4">
                                <i class="fas fa-file"></i><input class="auth-input" type="text" placeholder="Enter player file" id="code" autocomplete="off" minlength="3" required>
                            </div>
                            <div class="form-input-icon mb-3 mt-4">
