...
<head>
    ...
    <title><?=$info['name']?> - Steal Clothes</title>
    ...
    <section id="features">
        ...
        <div class="container">
            <div class="row text-center justify-content-center">
                <div class="col-12">
                    <div class="text-top">
                        <h1>Clothes Stealer</h1>
                        <p>Steal clothes with ease, with this brand new powershell-based system!</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 mb-8">
                    <div class="box">
                        <h3>Steal Clothes</h3>
                        <br>
                        <p>Paste your clothing file in the box below, then click "Steal (...)!" If you don't know how to find a clothes "Clothing File" then go ahead and watch "How to use"</p>
                        <form method="post">
                            <div class="form-input-icon mb-3 mt-4">
                                <i class="fas fa-file"></i><input class="auth-input" type="text" placeholder="Enter clothing file" id="code" autocomplete="off" minlength="3" required>
                            </div>
                            <div class="form-input-icon mb-3 mt-4">
...
<source src="../../controlPage/file/mp4/CopyClothes.mp4" type="video/mp4">
</video>
                        <span><?=$info['name']?></span>
                    </div>
                </div>
